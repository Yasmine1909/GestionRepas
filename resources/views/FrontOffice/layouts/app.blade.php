...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center topbar-scrolled" style="background-color: #0d4a75;">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <div class="logo me-auto">
            <a href="{{ url('/') }}">
                <img src="{{ asset('images/Logo-M2M-Group.png') }}" alt="M2M Logo" style="height:100%;">            </a>
        </div>
  ...
  <footer id="footer">
    <div class="container">
        <img src="{{ asset('images/Logo-M2M-Group.png') }}" alt="M2M Logo" style="height: 25%;width:25%;">      <div class="social-links">
